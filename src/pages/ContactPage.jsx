...
const faqItems = [
  {
    question: "How do I request changes to the content calendar?",
    answer: "You can reply to our approval email or message us directly.",
  },
  {
    question: "Can I send you photos or content ideas?",
    answer: "Yes. We encourage you to share behind-the-scenes content.",
  },
  {
    question: "How do I upgrade my package?",
    answer: "Just let us know, and we'll adjust your plan accordingly.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg mb-12 leading-relaxed">
                Whether you're looking to scale your business, launch a new
                product, or transform your digital strategy, we're here to help.
              </p>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 md:px-8 py-6 text-left flex items-start justify-between gap-4 hover:bg-white/5 transition-colors"
                  >
                    <div className="flex items-start gap-3">
                      <HelpCircle className="w-5 h-5 mt-1 text-cyan-400 flex-shrink-0" />
