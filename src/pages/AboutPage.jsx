import { Eye, Repeat, Zap } from "lucide-react";
...
const AboutPage = () => {
  ...
  const team = [
    {
      name: "Anthony Ojonimi",
      role: "Founder & Lead Strategist",
      expertise:
        "Leads social strategy, planning, and monthly optimization to ensure each client sees measurable growth.",
    },
    {
      name: "Chioma Jacob",
      role: "Content Strategy Lead",
      expertise:
        "Owns content calendars, campaign direction, and brand voice consistency across all channels",
    },
    {
      name: "Silva",
      role: "Graphics Designer",
      expertise:
        "Designs visual assets, branded creatives, and campaign graphics that make every post clear, polished, and on-brand.",
    },
    {
      name: "Olamide Olayemi",
      role: "Web and Software Engineer",
      expertise:
        "Builds and maintains the web and software systems that support campaign execution, reporting workflows, and team productivity.",
    },
  ];
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Marketing team planning session"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            We're not just consultants. We're growth partners obsessed with
            turning ambitious visions into market-dominating realities.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-6">
                Poleon started because we saw a gap in how businesses experience
                digital growth. Many were overwhelmed by social media, digital
                tools, and online marketing , yet results often fell short. We
                wanted to change that. Our approach is simple: clarity,
                consistency, and human-centered strategy.
              </p>
              <p className="text-lg text-gray-400 leading-relaxed">
                Every brand we work with is treated as a partner. We show what
                works, what doesn’t, and how we grow together, because real
                growth comes from real insight.
              </p>
            </div>
